...
The identification of these pain points motivated the creation of our app \emph{Clew} to support precise indoor navigation in unfamiliar environments.  In \emph{\nameref{sec:clewoverview}}, we present the apps major features and general technical architecture.  In \emph{\nameref{sec:usabilityandevaluation}}, we present both small and large-scale user studies that provide insight into the app's capabilities, suggest improvements to its design, and provide guidelines for developers of similar apps.
