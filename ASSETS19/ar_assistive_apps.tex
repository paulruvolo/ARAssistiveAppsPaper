...
\includegraphics[width=0.48\linewidth]{Figures/clew_screenshot_19}
\end{center}
\caption{TODO: update the caption.  Two screenshots from our app ``Clew'' in navigation mode (where a user is retracing a previously traveled route).  The text for the left image says ``Continue straight and proceed downstairs'' and the text on the right says ``Continue straight for 3.2 feet.''\label{fig:clewshots}}
\end{figure}
